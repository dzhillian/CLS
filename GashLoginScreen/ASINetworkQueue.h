...
@property (strong, nonatomic, setter=setUploadProgressDelegate:) id uploadProgressDelegate;
@property (strong, nonatomic, setter=setDownloadProgressDelegate:) id downloadProgressDelegate;
